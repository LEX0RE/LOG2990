...
export class GridCreateBoardService {
    ...
    constructor(grid: GridContextService) {
        this.grid = grid;
    ...
    createLines(): void {
        this.grid.gridContext.strokeStyle = LINE_COLOR;
    ...
    createColumns(): void {
        this.grid.gridContext.fillStyle = NUMBER_FILL_COLOR;
        this.grid.gridContext.font = `${NUMBER_FILL_STYLE}${FONT_UNIT} ${NUMBER_FILL_COLOR}`;
    ...
    starSquare(position: Vector2D): void {
        ...
        this.grid.gridContext.fillStyle = LETTER_COLOR;
    ...
    createSquare(position: Vector2D, color = DEFAULT_TILE_COLOR): void {
