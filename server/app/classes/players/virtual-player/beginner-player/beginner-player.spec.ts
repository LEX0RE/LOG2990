...
describe('BeginnerPlayer', () => {
    ...
    beforeEach(() => {
        ...
        newIndice = { score: fakeScore, action: new PlaceLetters([], fakePosition, Orientation.None) };
        hint.push(newIndice);
    ...
    it('should create a simple beginner player', () => {
        ...
        expect(player).to.ownProperty('id', FAKE_SOCKET_ID_PLAYER_1 + BEGINNER_ID);
    ...
    it('action should call SkipAction if chooseAction return unknow value (not placLetter,trade or skipTurn) ', () => {
    ...
    it('placeAction should return a place Letters with a Medium score if randomNumber is between 7 - 12 points ', () => {
        ...
        player['placeAction']().then((action: Action) => {
            expect(action).to.equal(newIndice.action);
        });
    });
    ...
    it('placeAction should return a place skipturn if there has no placement', () => {
    ...
    it('placeAction should return a place skipturn if the score is bigger than 18', () => {
        const percentage = 0.8;
        const fakeScore = 19;
    ...
    it('placeAction should return a place Letters with a medieum score if randomNumber is between 13 - 18 points but he doesnt have a score like this', () => {
        const percentage = 0.8;
