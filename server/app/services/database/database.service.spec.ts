...
import { DEFAULT_BEST_SCORES } from '@app/constants/default/default-best-scores';
...
describe('DatabaseService', () => {
    ...
    it('defaultData should return log collection', () => {
        expect(databaseService.defaultData(DATABASE_COLLECTION_LOG)).to.eql(DEFAULT_BEST_SCORES);
    });

    it('defaultData should return classic collection', () => {
        expect(databaseService.defaultData(DATABASE_COLLECTION_CLASSIC)).to.eql(DEFAULT_BEST_SCORES);
    });
    ...
    it('defaultData should return DEFAULT_BEST_SCORES collection', () => {
        const invalidCollection = 'INVALID COLLECTION';

        expect(databaseService.defaultData(invalidCollection)).to.eql(DEFAULT_BEST_SCORES);
    });
});
